...
{
    public class ElementObj_AuxiliaryRelay : ElementObjBase
    {
        [Header("元件名称"),SerializeField] string elementName = "中间继电器";
        [Header("元件类型"),SerializeField] ElectricalElmentType elementType = ElectricalElmentType.AuxiliaryRelay;
